...
const LinedEye = () => (
  ...
  >
    <path
      fill="#d6d6d6"
      d="M6.295 7.876 5 9.172c-1.333 1.333-2 2-2 2.828 0 .829.667 1.495 2 2.829l2.121 2.12a7 7 0 0 0 9.9 0l.411-.41-2.927-2.277a3.25 3.25 0 0 1-5.1-3.967l-3.11-2.419Z"
      opacity={0.1}
    />
    <path
      stroke="#d6d6d6"
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M9 5.627a7.003 7.003 0 0 1 7.85 1.423l3.001 3.002c.497.497.745.745.885 1.008a2 2 0 0 1 0 1.88c-.14.263-.388.511-.885 1.008v0L19.8 14"
    />
    <path
      fill="#d6d6d6"
